...
for tweet in tweepy.Cursor(api.search,
                           q="#callhandlers OR #callhandler OR #fireandrescue OR #policecontrolroom OR #PolScotControl OR #scotamb OR #teamhumberside OR #ControlRoomHeroes OR #Paramedic OR #teamlas OR #999family",
                           lang="en").items(10):
    try:

...
for tweet in tweepy.Cursor(api.search,
                           q="#callhandlers OR #callhandler OR #fireandrescue OR #policecontrolroom OR #teamyas OR #PolScotControl OR #teamhants OR #999family OR #teamhumberside OR #ControlRoomHeroes OR #TeamLAS",
                           lang="en").items(10):
    try:
